          ...
          <div class="middle-l" ref="middleL">
            ...
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper">
                <img :src="(currentSong.al && currentSong.al.picUrl) || (currentSong.artists && currentSong.artists[0].img1v1Url) " alt="" ref="imgae" :class="cdCls" class="image">
              </div>
            </div>
            <!-- 歌词 -->
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
         ...
         <div class="control">
          ...
          <!-- 歌曲播放的进度条 -->
        <div class="bottom-progross-bar">
          <div class="bottom-progross" :style="{width:(currentTime / duration).toFixed(3)*100 +'%'}"></div>
        </div>
      </div>
    </transition>
  </div>
